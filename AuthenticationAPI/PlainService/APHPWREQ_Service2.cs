...
{
    public class APHPWREQ_Service2 : IHttpTrxService
    {
        ...
        public APHPWREQ_Service2(ILogger<APREGCMP_Service> logger, IConfiguration configuration, ISecurityManager securitymanager, IObjectManager objectmanager)
        {
            Logger = logger;
        ...
        public HttpTrx HandlepHttpTrx(HttpTrx Msg)
        {
            ...
            {
                APHPWREQ aphpwreq = DeserializeObj._AHPWREQ(Msg.datacontent);
                if (aphpwreq == null)
                {
        ...
        //---- Re modify 
        private HttpTrx ReplyAPHPWPLY(string username, string devicetype, APHPWREQ aphpwreq)
        {
            HttpTrx HttpReply = null;
            string _replyProcessStep = ProcessStep.AHPW_PLY.ToString();
            ...
            try
            {
                ...
                {
                    APHPWPLY aphpwply = new APHPWPLY();
        ...
        private bool Handle_APHPWREQ(string username, string devicetype, APHPWREQ aphpwreq)
        {
