...
{
    public class ARREGCMPServiceLite : IHttpTrxService
    {
        private string _SeviceName = TransServiceLite.ARREGCMP_Lite.ToString();
        private readonly ILogger Logger;
        private readonly IConfiguration Configuration;
        private readonly ISecurityManager SecurityManager;
        private ObjectManager ObjectManagerInstance = null;

        public ARREGCMPServiceLite(ILogger<ARREGCMPService> logger, IConfiguration configuration, ISecurityManager securitymanager, IObjectManager objectmanager)
        {
        ...
        public HttpTrx HandlepHttpTrx(HttpTrx Msg)
        {
            ...
            {
                ARREGCMP apregcmp = DeserializeObj._APREGCMP(Msg.datacontent);
                if (apregcmp == null)
                {
